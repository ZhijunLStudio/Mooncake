...
os.environ["LD_LIBRARY_PATH"] = (
    f"{os.environ.get('CONDA_PREFIX', '/data/lizhijun/anaconda3')}/lib"
    f":{os.path.dirname(os.path.abspath(__file__))}/builddir/mooncake-common"
    f":{os.path.dirname(os.path.abspath(__file__))}/builddir/mooncake-store/src"
    f":{os.path.dirname(os.path.abspath(__file__))}/builddir/mooncake-transfer-engine/src"
